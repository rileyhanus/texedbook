...
\InsertIframe{<iframe width="560" height="315" src="https://www.youtube.com/embed/zqtx0gA5K2s?si=nLdAne1jF961EMxx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>}{Intro to Copyright}{MIT OpenCourseWare}{Video}
...
\end{verbatim}
\InsertYouTube{https://www.youtube.com/embed/zqtx0gA5K2s?si=VvkQh8POH3gqKmc0}{MIT OpenCourseWare: Introduction to Copyright Law}{Lecture 1 of MIT 6.912, Introduction to Copyright Law}
